...
public abstract class PlayableFighter extends Fighter implements
	...
	public PlayableFighter(String name, int maxHealthPoints, int blastDamage,
		...
		this(name, maxHealthPoints, blastDamage, physicalDamage, maxKi,
				maxStamina, new ArrayList<SuperAttack>(),
	...
	public PlayableFighter(String name, int maxHealthPoints, int blastDamage,
		...
		this(name, INITIAL_LEVEL, INITIAL_XP, INITIAL_TARGET_XP,
				maxHealthPoints, blastDamage, physicalDamage,
				INITIAL_ABILITY_POINTS, maxKi, maxStamina, superAttacks,
				ultimateAttacks);
	}
